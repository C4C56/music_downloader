...
def main():
    ...
    group_necessarypart = parser.add_argument_group('group necessary part', 'group development which is necessary used')
    group_necessarypart.add_argument('key_word', help='the word you search')
    group_necessarypart.add_argument('store_folder', help='the music download path')
    ...
    hash_dict_list = downloader.get_music_hash(base_url_list)
    download_url_dict = downloader.get_music_download_url(hash_dict_list)
